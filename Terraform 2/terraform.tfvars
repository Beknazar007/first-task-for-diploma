...
#Cluster 1
##############################################################################
cluster_name_primary            = "eks1-us-east-1a"
...
node_security_group_additional_rules = {
  ...
  ingress_ports_nlb = {
    description = "kubernetes.io/rule/nlb/client"
    protocol    = "tcp"
    from_port   = 32749
    to_port     = 32749
    type        = "ingress"
...
role_name_prefix_primary   = "VPC-CNI-IRSA-1"
